...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-siop-openid4vp-swift.git", exact: "0.30.2"),
		.package(url: "https://github.com/niscy-eudiw/eudi-lib-ios-openid4vci-swift.git", branch: "fix/par_3_max_retries"),
